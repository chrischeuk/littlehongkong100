...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_dependency(%q<actionpack>.freeze, [">= 6.0", "< 8.0"])
    s.add_dependency(%q<actionview>.freeze, [">= 6.0", "< 8.0"])
    s.add_dependency(%q<activerecord>.freeze, [">= 6.0", "< 8.0"])
    s.add_dependency(%q<jquery-rails>.freeze, ["~> 4.6.0"])
    s.add_dependency(%q<kaminari>.freeze, ["~> 1.2.2"])
